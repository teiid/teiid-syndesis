...
public abstract class Logger {
    ...
    protected KLogger.Level level = KLogger.Level.INFO;

    protected abstract void configureLogging() throws Exception;

    /**
     * Dispose of any logging resources
     */
    ...
    /**
     * Set the logging path of the logger instance
     *
     * @param logPath
     * @throws Exception
     */
     ...
     */
    public void log( KLogger.Level level,
