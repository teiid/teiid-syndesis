...
public interface KomodoObject extends KNode {
     ...
     * @see #getChild(String)
     */
    KomodoObject getChild( final String name,
     ...
     *         if the child does not exist or an error occurs
     */
    KomodoObject[] getChildren( final String... namePatterns ) throws KException;
     ...
     *         if an error occurs
     */
    KomodoObject[] getChildrenOfType( final String type,
     ...
     */
    Descriptor getDescriptor( final String typeName ) throws KException;
    ...
    /**
     * Subclasses may implement {@link #getChildren(String...)} in such a way that it does not represent the actual
    ...
    /**
     * Subclasses may implement {@link #getPropertyNames()} in such a way that it does not represent the actual set of
     ...
     *         if error occurs
     */
    KomodoType getTypeIdentifier( ) throws KException;
     ...
     *         if an error occurs
     */
    boolean hasDescriptor( final String descriptorName ) throws KException;
