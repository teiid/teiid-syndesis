alter table data_virtualization add column created_at timestamp;
...
alter table source_schema add column created_at timestamp;
alter table source_schema add column modified_at timestamp;
...
alter table view_definition add column created_at timestamp; 
alter table view_definition add column modified_at timestamp;
