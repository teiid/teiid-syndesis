...
public class MongoDBDefinition extends DataSourceDefinition {
    ...
    public String getPomDendencies() {
        return  "<dependency>" +
            ...
            "  <artifactId>teiid-mondodb</artifactId>" +
            "</dependency>";
    }
    ...
    public Properties transformProperties(Map<String, String> svcProperties) {
        ...
        */
        ...
        props.setProperty("RemoteServerList", svcProperties.get("DATABASE_SERVICE_NAME")+":27017");
        props.setProperty("Username", svcProperties.get("database-user"));
        props.setProperty("Password", svcProperties.get("database-password"));
        props.setProperty("Database", svcProperties.get("database-name"));
        props.setProperty("SecurityType", "SCRAM_SHA_1");
        props.setProperty("AuthDatabase", svcProperties.get("database-name"));
