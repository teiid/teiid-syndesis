...
public class KomodoMetadataService extends KomodoService {
    ...
    private boolean hasDriver(String driverName) throws Exception {
        ...
        try {
            Collection<ConnectionDriver> drivers = getMetadataInstance().getDrivers();
...
//     */
//    @POST
//    @Path( V1Constants.VDBS_SEGMENT + StringConstants.FORWARD_SLASH + V1Constants.MODEL_FROM_METADATA_DDL )
//    @Produces( MediaType.APPLICATION_JSON )
