...
public class AbstractSyndesisConnectionProcessor implements V1Constants {
	...
	public AbstractSyndesisConnectionProcessor(KEngine kengine) {
		super();
		this.kengine = kengine;
	}
	
    protected synchronized MetadataInstance getMetadataInstance() throws KException {
        return this.kengine.getMetadataInstance();
    }

    protected String getSchema(UnitOfWork uow, String vdbName, String modelName) throws Exception {
        MetadataInstance mServer = getMetadataInstance();
        return mServer.getSchema(vdbName, "1", modelName); //$NON-NLS-1$
    }

    protected boolean hasDriver(String driverName) throws Exception {
    ...
    protected boolean hasDynamicVdb(String vdbName) throws Exception {
    ...
    protected boolean hasDataSource(String dataSourceName) throws Exception {
    ...
    protected String extractServiceVdbName(UnitOfWork uow, WorkspaceManager mgr, String dsPath) throws KException {
     ...
     */
    protected DeployStatus doDeploySourceVdb( final UnitOfWork uow,
     ...
     * @throws KException
     */
    protected Model addModelToSchemaVdb(final UnitOfWork uow, final Vdb schemaVdb, final TeiidDataSource dataSource, final String schemaModelName) throws KException {
        // create schema model
     ...
     * @throws KException
     */
    protected Vdb findWorkspaceSyndesisSourceVdb( final UnitOfWork uow,
     ...
     * @throws KException
     */
    protected ModelSource findWorkspaceSyndesisSourceVdbModelSource( final UnitOfWork uow,
                                                                   final TeiidDataSource dataSource ) throws KException {
     ...
     * @throws KException
     */
    protected Vdb findWorkspaceSchemaVdb( final UnitOfWork uow,
                                        final TeiidDataSource dataSource ) throws KException {
        final String dataSourceName = dataSource.getName( );
     ...
     * @throws KException
     */
    protected Model findSchemaModel( final UnitOfWork uow,
                                   final TeiidDataSource dataSource ) throws KException {
     ...
     * @throws KException
     */
    protected TeiidDataSource findTeiidSource( final String sourceName ) throws KException {
     ...
     * @throws KException
     */
    protected TeiidVdb findDeployedVdb( final String sourceName ) throws KException {
     ...
     */
    protected String getSchemaVdbName( final String sourceName ) {
     ...
     */
    protected String getWorkspaceSourceVdbName( final String sourceName ) {
     ...
     */
    protected String getSchemaModelName( final String sourceName ) {
     ...
     */
    protected String createSchemaNodePath(int iPosn, String[] segments) {
     ...
     */
    protected String getSegmentType(String segment) {
        String[] parts = segment.split(EQUALS);
        return parts[0].trim();
    }
     ...
     */
    protected void setSchemaStatus( final UnitOfWork uow,
