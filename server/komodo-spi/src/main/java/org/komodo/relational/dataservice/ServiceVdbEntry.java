 ...
 */
public interface ServiceVdbEntry extends Exportable, RelationalObject {
    ...
    default byte[] export( final UnitOfWork transaction,
        ...
        final Vdb resource = getReference( transaction );
     ...
     *         if an error occurs
     */
    Vdb getReference( final UnitOfWork transaction ) throws KException;
    ...
    void setReference( final UnitOfWork transaction,
                               final Vdb reference ) throws KException;
