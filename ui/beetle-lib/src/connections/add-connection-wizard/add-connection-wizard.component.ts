...
import { NewConnection } from "../shared/new-connection.model";
import { ServiceCatalogSource } from "../shared/service-catalog-source.model";
...
@Component({
  ...
  selector: "btl-add-connection-wizard",
