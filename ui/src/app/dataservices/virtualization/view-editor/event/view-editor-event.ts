...
export class ViewEditorEvent {
  ...
  /**
   * @returns the optional args to the event (never `null` but can be empty)
   */
  public get args(): any[] {
    return this._args;
  }
  ...
  /**
   * @returns `true` if the canvas editor part was the source of the event
   */
  ...
  /**
   * @returns `true` if the editor was the source of the event
   */
  ...
  /**
   * @returns `true` if the header editor part was the source of the event
   */
  ...
  /**
   * @returns `true` if the message log part was the source of the event
   */
  ...
  /**
   * @returns `true` if the preview editor part was the source of the event
   */
  ...
  /**
   * @returns `true` if the properties editor part was the source of the event
   */
  ...
  /**
   * @returns `true` if the projected columns editor part was the source of the event
   */
  ...
  /**
   * @returns `true` if the type is {@link ViewEditorEventType.CANVAS_SELECTION_CHANGED}
   */
  ...
  /**
   * @returns `true` if the type is {@link ViewEditorEventType.EDITED_VIEW_SET}
   */
  ...
  /**
   * @returns `true` if the type is {@link ViewEditorEventType.EDITOR_CONFIG_CHANGED}
   */
  ...
  /**
   * @returns `true` if the type is {@link ViewEditorEventType.EDITOR_VIEW_SAVE_PROGRESS_CHANGED}
   */
  ...
  /**
   * @returns `true` if the type is {@link ViewEditorEventType.LOG_MESSAGE_ADDED}
   */
  ...
  /**
   * @returns `true` if the type is {@link ViewEditorEventType.LOG_MESSAGE_DELETED}
   */
  ...
  /**
   * @returns `true` if the type is {@link ViewEditorEventType.LOG_MESSAGES_CLEARED}
   */
  ...
  /**
   * @returns `true` if the type is {@link ViewEditorEventType.PREVIEW_RESULTS_CHANGED}
   */
  ...
  /**
   * @returns `true` if the type is {@link ViewEditorEventType.READONLY_CHANGED}
   */
  ...
  /**
   * @returns `true` if the type is {@link ViewEditorEventType.RESTORE_EDITOR_STATE}.
   */
  ...
  /**
   * @returns `true` if the type is {@link ViewEditorEventType.SHOW_EDITOR_PART}
   */
  ...
  /**
   * @returns `true` if the type is {@link ViewEditorEventType.VIEW_STATE_CHANGED}
   */
  ...
  /**
   * @returns `true` if the type is `ViewEditorEventType.CREATE_SOURCE`
   */
  ...
  /**
   * @returns `true` if the type is `ViewEditorEventType.CREATE_COMPOSITION`
   */
  ...
  /**
   * @returns `true` if the type is `ViewEditorEventType.DELETE_NODE`
   */
