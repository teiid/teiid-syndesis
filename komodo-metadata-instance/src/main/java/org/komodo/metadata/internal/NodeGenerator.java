...
public class NodeGenerator implements StringConstants {
     ...
     */
    protected IndexKey createKey(LanguageObject obj, Node node) throws RepositoryException {
    ...
    protected void index(LanguageObject obj, Node node) throws RepositoryException {
        if (objectIndex == null)
    ...
    protected Node node(LanguageObject obj) throws RepositoryException {
        if (objectIndex == null)
            return null;
